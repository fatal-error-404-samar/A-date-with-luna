...
def scn012():
    print("Error 404")
    print("visit my github accounts at https://github.com/fatal-error-404-samar")
    print("I'm not implenting it soon")
    print("Have a good day")
    print("#content will be added later")
def scn01122():
    print('"WHAT THE HELL? F🤬CK OFF! I'+"'"+'M LEAVING"')
